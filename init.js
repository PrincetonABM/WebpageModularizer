...
chrome.browserAction.onClicked.addListener(function(tab) {
	...
	chrome.tabs.insertCSS(null, {file: "jquery-ui.custom/css/pepper-grinder/jquery-ui-1.10.2.custom.css"});
	//inject css to be used with the modulr program
	chrome.tabs.insertCSS(null, {file: "ModulrStyle.css"});
	...
	chrome.tabs.executeScript(null, { file: "jquery-1.9.1.min.js" }, function() {
			...
			chrome.tabs.executeScript(null, { file: "jquery.tabSlideOut.js" }, function() {
